...
export default async function DemoLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <EntityProvider>
      <ProcessorProvider>
        <div className="flex items-center justify-between rounded-t-lg bg-gradient-to-b from-gray-100 to-gray-200 px-10 py-5 shadow-lg">
          <Link href={"/"}>
            <svg
              id="Logos"
              ...
              <g id="Primary">
                <g id="Tazama">
                  <polygon
                    className="st0"
                    fill="#003c30"
                    points="463.5 26.5 296.6 26.5 296.6 58.7 362.9 58.7 362.9 231.4 397.1 231.4 397.1 58.7 463.5 58.7 463.5 26.5"
                  />
                  <path
                    className="st2"
                    fill="#003c30"
