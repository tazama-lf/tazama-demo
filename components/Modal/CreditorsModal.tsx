...
const CreditorModal = ({ ...props }: Props) => {
  ...
  useEffect(() => {
    if (processCtx.creditorActiveSection === "Entity") {
    ...
    } else if (processCtx.creditorActiveSection === "Accounts") {
      let acctData = processCtx.conditionsDataCreditor.conditions.filter((con: ListCondition) => {
        return "acct" in con
      })
      let filteredAcctData = acctData.filter((con) => {
        ...
        let acctId: string | undefined =
          entityCtx.creditorEntities[nttyIndex !== undefined ? nttyIndex : 0]?.CreditorAccounts[
            acctIndex !== undefined ? acctIndex : 0
          ]?.CdtrAcct.Id.Othr[0].Id
  ...
  useEffect(() => {
    ;(async function () {
      ...
      if (processCtx.creditorActiveSection === "Accounts") {
      ...
      } else if (processCtx.creditorActiveSection === "Entity") {
    ...
    processCtx.creditorActiveSection,
  ...
  const accounts =
    typeof props.selectedEntity === "number" ? entityCtx.creditorEntities[props.selectedEntity]?.CreditorAccounts : []
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center gap-[2px] p-4 sm:items-center sm:p-0">
            <div className="relative flex h-[790px] min-w-[490px] flex-col justify-between overflow-hidden rounded-lg bg-gray-200 p-5">
              ...
              <div className="my-4 flex justify-around">
                <button
                  className={`rounded-lg px-4 py-2 ${
                    processCtx.creditorActiveSection === "Entity"
              ...
              <div
                className={`${
                  processCtx.creditorActiveSection === "Entity" ? "top-[20%]" : "top-[20%]"
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`z-1 relative ${processCtx.showCreditorConditions === true ? "rotate-180" : "rotate-0"}`}
                  >
                    ...
                    <div className="text-left [&>div>input]:rounded-lg [&>div>input]:bg-gray-200 [&>div>input]:p-2 [&>div>input]:shadow-inner [&>div]:mb-2 [&>div]:pr-5">
                      ...
                      <div className="flex flex-col">
                        ...
                        <DatePicker
                          ...
                          showIcon
                          selected={
                            customEntity?.Cdtr.Id.PrvtId.DtAndPlcOfBirth.BirthDt
                ...
                <>
                  <div className={"flex grid h-[450px] grid-cols-1 gap-2 overflow-auto"}>
                    {customAccounts.map((accountDetail, index) => (
                      <div
                        key={index}
                        className="shadow-small flex flex max-h-[280px] cursor-pointer flex-col rounded-lg border p-4 hover:bg-zinc-300"
                        onClick={() => {
                          entityCtx.selectCreditorEntity(
                          ...
                          <div className="w-full text-left">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full rounded-lg bg-gray-200 p-2 shadow-inner"
                                value={accountDetail.CdtrAcct.Id.Othr[0]?.Id}
                                readOnly
                              />
                            </div>
                            <div>
                              ...
                              <input
                                ...
                                className="w-full rounded-lg bg-gray-200 p-2 shadow-inner"
                                value={accountDetail.CdtrAcct.Id.Othr[0]?.SchmeNm.Prtry}
                                readOnly
                              />
                            </div>
                          </div>
