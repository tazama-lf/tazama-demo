...
import { checkActiveCreditorEntity, checkIsActiveCreditorAccount } from "utils/helpers"
    ...
    >
      ...
      >
        ...
        <div className="mt-1 flex flex-col items-center justify-center gap-1">
          ...
          {entityCtx.creditorEntities[props.index]?.CreditorEntity ? (
            <StatusIndicator
              customSize={12}
              colour={checkActiveCreditorEntity(
                processCtx.conditionsDataCreditor,
                entityCtx.creditorEntities[props.index]
              )}
            />
          ) : (
